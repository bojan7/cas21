            ...
            <?php foreach ($vozilo as $v) {  ?>
                ...
                <select name="proizvodjacivozila">
                    ...
                    foreach ($sviproizvodjaci as $proizvodjac) {
                        ...
                        <option value="<?php echo $proizvodjac['imeproizvodjaca'] ?>" <?php if ($proizvodjac['imeproizvodjaca'] == $v['imeproizvodjaca']) echo 'selected'; ?>>
                    ...
                    <select>
                        ...
                        <select name="kategorijavozila">
                            ...
                            foreach ($svekategorije as $kat) {
                                ...
                                <option value="<?php echo $kat['kategorija'] ?>" <?php if ($kat['kategorija'] == $v['kategorija']) echo 'selected'; ?>>
